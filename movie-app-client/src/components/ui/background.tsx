...
function Bg() {
    return (
        <div className="fixed top-0 right-0 h-screen w-screen bg-[#093545] -z-[2]" style={{ top: 0 }}>
            <div className="relative w-full h-full">
                <svg
                    className="absolute bottom-0 left-0 w-full h-auto z-50 pointer-events-none -z-[1]"
                    viewBox="0 0 428 111"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    preserveAspectRatio="none"
                    style={{ maxHeight: '111px', bottom: 0 }}
                >
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
